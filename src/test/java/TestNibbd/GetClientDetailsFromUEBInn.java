...
public class GetClientDetailsFromUEBInn {
    ...
    private final static Integer CLIENTIDOK = 378944;
    private final static Integer CLIENTIDERROR = 912;
    ...
    public void getClientDetailsFromUEBInnPositive() {
    ...
    @Test(groups = {"EBP"})
    @Description("Отправка запроса в ЕБП на идентификацию клиента ЮЛ по ИНН - оишибка по идентификации от ЕБП")
